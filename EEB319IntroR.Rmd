...
#### Importing Data  
Remember to make sure your .csv files are stored in your *working directory* (above). **You can import your data using read.csv():**  
...
InfecData_r03 <- read.csv("ModelSimulation_1.csv") # NOTE: that you need to include the entire pathname for your .csv within the quotation marks.
```
...
```{r, eval=TRUE}
plot(InfecData_r03$time, InfecData_r03$parasites, type = "l", col = "goldenrod1", lwd = 4, xlab="Time", ylab="Abundance", main = "Within-Host Population Dynamics, r = 0.3")
...
Now, try to **plot all three of your simulations** like the example above, with some aesthetic changes! You can use [STHDA](http://www.sthda.com/english/wiki/line-plots-r-base-graphs) and [Towards Data Science](https://towardsdatascience.com/base-plotting-in-r-eb365da06b22) as references!  
```{r, eval=TRUE}
# YOUR WORK HERE!
```
